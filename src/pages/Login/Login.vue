<template>
  ...
  <div class="center">
    <el-form v-show="Login === 'SignIn'" :model="SignIn" label-width="7em" ref="SignIn" :rules="signin_rules">
      ...
      <el-form-item>
        <p class="mt-5 mb-3 text-muted">&copy; 2019 厦门大学软件学院</p>
      </el-form-item>
    </el-form>
    ...
    <el-form v-show="Login === 'FindPassword'" :model="FindPassword" label-width="7em" ref="FindPassword">
      <el-form-item>
        <h1 class="h2 font-weight-normal mb-5">找回密码</h1>
      </el-form-item>
      <el-form-item label="手机号" prop="phoneNumber">
        <el-input placeholder="请输入需要找回密码的手机号" v-model="FindPassword.phoneNumber"></el-input>
      </el-form-item>
      <el-form-item>
        <div class="center">
...
export default {
  ...
  methods: {
    ...
    sendMail (formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          reqSendMail(this.FindPassword.phoneNumber).then((data) => {
